...
class User extends Authenticatable implements JWTSubject
{
    ...
    public function intoShareable(): array
    {
        return [
            ...
            'is_news_notification_enabled' => $this['is_news_notification_enabled'],
            'is_new_opportunity_notification_enabled' => $this['is_new_opportunity_notification_enabled'],
            'is_app_opportunity_notification_enabled' => $this['is_app_opportunity_notification_enabled'],
            'status' => $this['status'],
